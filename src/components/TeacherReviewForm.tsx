  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const url = isEditMode
        ? `/api/teacher-reviews/${existingReview!.id}`
        : "/api/teacher-reviews";
      ...
      const res = await fetch(url, {
        ...
        body: JSON.stringify({ rating, content, teacherId }),
      });
            ...
            {success ? (
              ...
              <>
                <h3 className="text-xl font-bold mb-1">
                  {isEditMode ? "编辑评价" : "评价老师"}
                </h3>
                <p className="text-gray-500 text-sm mb-6">
                  分享您的真实上课体验，帮助其他学员做出选择
                </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      placeholder="说说这位老师的教学质量、授课风格、答疑态度等..."
                      value={content}
